...
let firstLevelStoryItems: [StoryItem] = [
    StoryItem(id: 0, type: .shader(.neuron),     text: "I'm a special neuron slide with animations..."),
    StoryItem(id: 1, type: .shader(.neuralBlue), text: "Blue neural network slide..."),
    StoryItem(id: 2, type: .shader(.neuralGreen),text: "Green network slide..."),
    StoryItem(id: 3, type: .image("someImage"),  text: "A nice photo or image slide..."),
]
